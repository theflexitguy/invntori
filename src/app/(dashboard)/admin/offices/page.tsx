      ...
      <div className="bg-[#1a1f2e] border border-[#2a2f3e] rounded-xl overflow-hidden">
        {offices.length === 0 ? (
          ...
          <div className="divide-y divide-[#2a2f3e]">
            {offices.map((office) => (
              <div key={office.id} className="flex items-center gap-4 px-5 py-4">
                <div
                ...
                {user?.isAdmin && (
                  <div className="flex items-center gap-1 shrink-0">
                    <button onClick={() => openEdit(office)} className="px-2.5 py-1.5 text-xs rounded-lg text-gray-400 hover:text-white hover:bg-white/5 transition-colors">Edit</button>
                    <button onClick={() => setConfirmDelete(office)} className="px-2.5 py-1.5 text-xs rounded-lg text-red-400 hover:bg-red-400/10 transition-colors">Delete</button>
                  </div>
                )}
              </div>
            ))}
