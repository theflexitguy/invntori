    ...
    items: [
      {
        ...
        description: "View, activate, and set roles & permissions",
        icon: (
      ...
      },
      {
        ...
        description: "Add and edit company office locations",
        icon: (
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      },
      {
        ...
        description: "Configure storage and warehouse locations",
        icon: (
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      },
      {
        ...
        description: "Company name, AI provider, and integrations",
        icon: (
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        description: "Units of measurement (oz, gallon, etc.)",
        icon: (
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      },
      {
        ...
        description: "Product catalog, costs, and reorder levels",
        icon: (
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {
        href: "/admin/detail-fields",
        label: "Manage Detail Fields",
        description: "Custom fields shown on inventory items",
        icon: (
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    items: [
      {
        ...
        description: "Review and fulfill all employee inventory requests",
        icon: (
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      },
      {
        ...
        description: "Adjust inventory quantities with an audit trail",
        icon: (
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {
        href: "/admin/equipment-repairs",
        label: "Equipment Repairs",
        description: "Review, approve, and resolve repair requests",
        icon: (
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z" />
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
    ...
    items: [
      {
        ...
        description: "Total inventory value across all warehouses",
        icon: (
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="space-y-6">
        {ADMIN_SECTIONS.map((section) => (
          <div key={section.title}>
            ...
            <div className="bg-[#1a1f2e] border border-[#2a2f3e] rounded-xl overflow-hidden divide-y divide-[#2a2f3e]">
